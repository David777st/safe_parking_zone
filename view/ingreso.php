...
<head>
    ...
    <title>Ingreso - SafeParkingZone</title>
...
?>
    ...
    <div class="login-container">
        <h2 class="login-title">Ingreso a SafeParkingZone</h2>
        <form action="../controller/login.php" method="POST"> <!-- Cambiado para apuntar a ingreso.php -->
            <div class="mb-3">
